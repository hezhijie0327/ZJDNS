...
[![Version](https://img.shields.io/badge/Version-3.6.14-informational)](https://github.com/hezhijie0327/ZJDNS/releases)
...
GFW 通过抢先注入假 DNS 响应（UDP）和 RST 重置（TCP）来干扰 DNS 查询。
