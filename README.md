...
[![Version](https://img.shields.io/badge/Version-3.2.20-informational)](https://github.com/hezhijie0327/ZJDNS/releases)
...
| `ruleset_entries` | 规则集条目（tag + type + value，SQLite 运行时查询） |
| `infra_cache` | 权威服务器状态（RTT、EDNS 能力、超时退避） |
| `zone_entries` | 区域规则匹配（复合主键，zstd 压缩 BLOB） |
